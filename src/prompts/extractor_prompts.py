...
6. TOTAL YEARS CALCULATION — In `position_applied`, calculate `total_years_experience` by counting years from the candidate's earliest job start date to latest/current job end date.
